      ...
      <section className="">
        ...
        >
          <div className="flex order-2 xl:order-1 lg:order-1 md:order-1 sm:order-1 flex-col justify-center space-y-4 ">
            ...
            <p className="xl:text-lg lg:text-lg md:text-lg sm:text-base text-sm">
              ...
              maintaining their independence and quality of life. Our trained
              care givers provide assistance with daily activities, such as
              bathing, dressing, and meal preparation, as well as companionship
              to help prevent loneliness and promote mental well-being and peace
              of mind for both clients and their families.
            </p>
            <p className="xl:text-lg lg:text-lg md:text-lg sm:text-base text-sm">
              {" "}
              It aims to enhance the quality of life, promote autonomy, and
              foster a sense of community. Beneficiaries include individuals
              with physical, intellectual, or developmental disabilities who
              seek to maintain independence while having access to tailored
              support that empowers them to achieve their fullest potential.
            </p>
          </div>
        ...
        >
          ...
          <div className="flex flex-col justify-center space-y-4">
            ...
            <p className="xl:text-lg lg:text-lg md:text-lg sm:text-base text-sm">
              ...
              disabilities. Our disability support services are customized to
              each client&apos;s needs, focusing on promoting independence,
              mobility, and safety. From help with personal care and daily
              routines to specialized support with mobility and communication,
              we are here to assist with respect and sensitivity.
            </p>
            <p className="xl:text-lg lg:text-lg md:text-lg sm:text-base text-sm">
              {" "}
        ...
        >
          <div className="flex order-2 xl:order-1 lg:order-1 md:order-1 sm:order-1 flex-col justify-center space-y-4 mb-10">
            ...
            <p className="xl:text-lg lg:text-lg md:text-lg sm:text-base text-sm">
              Recovering from surgery can be challenging, but you don&apos;t
              have to do it alone. Our goal is to ensure a smooth recovery
              process by providing professional, compassionate care in the
        ...
        >
          ...
          <div className="flex order-2 xl:order-1 lg:order-1 md:order-1 sm:order-1 flex-col justify-center space-y-4 mb-10">
            ...
            <p className="xl:text-lg lg:text-lg md:text-lg sm:text-base text-sm">
              ...
              and grooming, we help maintain a clean, safe, and comfortable
              living environment. Let us take care of the daily tasks so you can
